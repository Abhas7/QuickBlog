...
const AddBlog = () => {
    ...
    const onSubmitHandler = async (e) => {
        e.preventDefault();
        // Now you can use the description state for the blog content
        // Example: console.log({ title, subTitle, description, category, isPublished, image })
        // If you need to await an API call, you can do it here
